...
export function Button({ children, trailing, href, onClick, className = "", type, disabled }: ButtonProps) {
  const baseStyles = "flex items-center h-7 gap-1.5 px-3 py-0.5 rounded-[10px] text-base font-book leading-[1.45] tracking-[0.07px] opsz-20 ff-body text-t11 hover:bg-t1 hover:text-t10 transition-colors";
